...
$palette=substr($GLOBALS['TL_DCA']['tl_newsletter_channel']['palettes']['default'],0,$pos).'{cleverreach_legend},clr_listId;'.substr($GLOBALS['TL_DCA']['tl_newsletter_channel']['palettes']['default'],$pos);
